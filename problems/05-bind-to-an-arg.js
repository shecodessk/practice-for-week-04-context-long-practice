//You need to pass this, as the binding method will expect context as its first argument. Because we want bindToAnArg to always bind to the arg passed, this should always refer to bindToAnArg.
